...
// Professional Tools
router.get('/sentiment/:coinId', CryptoController.getSentiment);
router.get('/whales', CryptoController.getWhaleAlerts);
router.get('/portfolio-history', isAuthenticated, CryptoController.getPortfolioHistory);
router.post('/limit-order', isAuthenticated, CryptoController.placeLimitOrder);
